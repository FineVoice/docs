...
<AccordionGroup>
  <Accordion title="Create a FineVoice account" icon="copy">
    **1. Visit the FineVoice Website**
    ...
    [**Open FineVoice**](https://finevoice.fineshare.com/) on your browser, and you can find the “Sign up” / “Sign in” button in the top right corner.

    **2. Choose a Sign up or Sign in Method**

    - \*\*Method 1: Register/Login with a Google Account \*\*
    ...
    - **Method 2: Register/Login with an Apple Accoun**
    ...
    - **Method 3: Register/Login with Email**
...
- [**API Reference**](https://fvdocs.fineshare.com/api-reference/introduction) - Complete API documentation
- [**Discord Community**](https://discord.com/invite/HquSyU4Dy8) - Get help from the commun**i**ty
- [**Support Email**](mailto:support@fineshare.ai) - Contact our support team